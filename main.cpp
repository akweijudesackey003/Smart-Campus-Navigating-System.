...
//MDC
setfillstyle(LTSLASH_FILL,BROWN);
rectangle(750,1,850,40);
floodfill(755,2,WHITE);
outtextxy(780,10,"MDC");
...
//Block 1
setfillstyle(CLOSE_DOT_FILL,LIGHTGRAY);
rectangle(300,400,400,550);
floodfill(301,401,WHITE);
outtextxy(310,470,"BLOCK 1");

//Energy House
setfillstyle(CLOSE_DOT_FILL,LIGHTBLUE);
rectangle(300,575,400,650);
floodfill(301,580,WHITE);
outtextxy(300,600,"ENERGY HOUSE");
//OLDAMPHI
setfillstyle(WIDE_DOT_FILL,LIGHTCYAN);
rectangle(190,400,280,500);
floodfill(201,401,WHITE);
outtextxy(200,450,"OLDAMPHI");
...
//NEWAMPHI
setfillstyle(WIDE_DOT_FILL,LIGHTCYAN);
rectangle(860,390,890,550);
floodfill(861,391,WHITE);
outtextxy(861,450,"NEW");
outtextxy(861,470,"AMPHI");
